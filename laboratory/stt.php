...
$hasPermission = $app->hasPermission($_SESSION['roleId'], 'standard-test-type');
?>
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
        <li class="breadcrumb-item">Masters</li>
        <li class="breadcrumb-item active" aria-current="page">Standard Test Type</li>
    </ol>
</nav>
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-baseline">
                    <h6 class="card-title mb-0">Standard Test Type List</h6>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive-md">
                    <table id="testtypelist" class="table">
                        <thead>
                            <tr>
                                <!-- <th>Category</th> -->
                                <th>Name</th>
...
<div class="modal fade" id="testGroupModal">
    <div class="modal-dialog modal-lg">
        <form method="post" action="testtype" id="testtypeform" autocomplete="off">
...
<script src="<?php echo BASE_URL; ?>includes/js/stt.js"></script>
</body>
