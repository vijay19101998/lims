...
class TCPDF {
	...
	public function GetLeftMargin($pagenum=null) {
		if (empty($pagenum)) {
			return $this->l;
		}
		return $this->pagedim[$pagenum]['l'];
	}

	public function GetRightMargin($pagenum=null) {
		if (empty($pagenum)) {
			return $this->r;
		}
		return $this->pagedim[$pagenum]['r'];
	}
	 ...
	 * @public
	 */
	public function setFooterData($ht='', $hs='',$tc=array(0,0,0), $lc=array(0,0,0)) {
		$this->footer_text_color = $tc;
		$this->footer_line_color = $lc;
		$this->header_title1 = $ht;
		$this->header_string1 = $hs;
	}
	...
	public function getFooterData() {
		...
		$ret['logo'] = $this->header_logo;
		$ret['logo_width'] = $this->header_logo_width;
		$ret['title'] = $this->header_title1;
		$ret['string'] = $this->header_string1;
		$ret['text_color'] = $this->header_text_color;
		$ret['line_color'] = $this->header_line_color;
		return $ret;
	}
