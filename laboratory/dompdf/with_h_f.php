    ...
    <footer>
       ...
       <header>
        ...
        <div style="display: inline-block; margin-left: 120px;">
            <p style="margin: 0; padding: 0; margin-left: -150px; text-align: left; color: red; line-height: 1.5;"><b>FOOD SAFETY AND ANALYTICAL QUALITY CONTROL LABORATORY</b></p>
           <p style="margin: 0; padding: 0; margin-left: -150px; text-align: left; color: black; line-height: 1.5;">
        ...
        <img src="'.$base64.'" style=" top: -10px; right: 150px; height: 60px; width: 60px;">
        <div style="color:#000"; class="image-caption">TC-7537</div>
