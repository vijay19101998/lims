...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Sample Library</li>
    </ol>
</nav>
        ...
        <div class="card">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4 mb-3">
								<select required="required" class="form-control" id="selectType" name="selectType">
            ...
            <div class="col-md-4 mb-3" style="display:none;" id="ipType">
								<select class="form-control js-example-tags" id="input_data" name="input_data" placeholder="select">
									<option value="">-------Select-------</option>
								</select>
							</div>
                </div>
...
<script src="<?php echo BASE_URL; ?>includes/js/test-report.js"></script>
