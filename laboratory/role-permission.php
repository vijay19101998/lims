...
// $array = json_encode($modules, true);


// print_r($modules['User Configuration']['usertype']);
?>
  ...
  <div class="col-md-12">
    <div class="">
      <div class="accordion" id="accordionExample">
        <form method="POST" action="rolepermission" id="rolepermission">
          <div class="col-md-6 mb-4">
            ...
            <button type="submit" id="" class="btn btn-xs btn-warning test mt-2" style="float: right;">Submit</button>
          </form>
        </div>
      </div>
    </div>
