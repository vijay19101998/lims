...
// $gettestcat = $app->gettestcat();
// $get_group = $app->get_group();
// $get_ssample = $app->get_ssample();
?>
<style>
    .go {
        margin-top: 25px;
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-baseline">
                    <h6 class="card-title mb-0">TRACK SAMPLES LIST</h6>
                    <!--  -->
            ...
            <div class="card-body">
                ...
                <div id="content">
                    ...
                    <table id="tracksample" class="table">
                        <thead>
                            <tr>
                                <th>Sample Code</th>
...
<script src="<?php echo BASE_URL; ?>includes/js/track-sample.js"></script>
</body>
