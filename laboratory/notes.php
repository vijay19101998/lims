...
$hasPermission = $app->hasPermission($_SESSION['roleId'], 'notes');
?>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-baseline">
                    <h6 class="card-title mb-0">Notes Creation List</h6>
                    <?php if($hasPermission["create"]=='true') { ?>
                    <button class="btn btn-sm btn-primary btn-icon-text" id="addType">
...
<div class="modal fade" id="typeModal">
    <div class="modal-dialog modal-lg">
        <form method="post" action="notessubmit" id="typeForm" autocomplete="off">
...
<script src="<?php echo BASE_URL; ?>includes/js/notes.js"></script>
</body>
