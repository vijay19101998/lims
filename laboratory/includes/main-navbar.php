...
if(!isset($menu_sub_active)){
	$menu_sub_active = '';
}
$login_display_name=Session::get("name");
$login_display_email=Session::get("email");
$loginRoleId = Session::get("roleId");
$menuMainList = array("dashboard"=>'');
$menuMainList[$menu_active] = ' active';
$menuSubList = array("dashboard"=>'');
$menuSubList[$menu_sub_active] = ' active';


// print_r($login_display_name);
// exit;
...
<nav class="sidebar">
      <div class="sidebar-header">
        <a href="#" class="sidebar-brand" style="display:inline-block; font-size: x-large">
          <span style="white-space:nowrap;" class="fs-100 text-secondary"><b> <img src="assets/images/logo2.png" alt="logo" width="45" height="45"> Laboratory</b></span>
        </a>
      ...
      <div class="sidebar-body">
        <?php 
          // include_once(filePath."/menu_vertical_user.php");
  if($_SESSION['roleId']==1){
          include_once(filePath."/menu_vertical_admin.php");
        } else{
          include_once(filePath."/menu_vertical.php");
...
<nav class="navbar">
            ...
            <span><b><?=$_SESSION['name'];?></b></span>
							<a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<img class="wd-30 ht-30 rounded-circle" src="https://cdn-icons-png.flaticon.com/512/7153/7153150.png" alt="profile">
							</a>
							<div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
								<div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
									...
									<div class="text-center">
										<p class="tx-16 fw-bolder"><?=$_SESSION['name'];?></p>
										<p class="tx-12 text-muted"><?=$_SESSION['email'];?></p>
									</div>
								</div>
                <ul class="list-unstyled p-1">
                  <li class="dropdown-item py-2">
                    <a href="<?php echo BASE_URL; ?>profile.php" class="text-body ms-0">
                  ...
                  <a href="<?php echo BASE_URL; ?>logout.php" class="text-body ms-0">
                  <li class="dropdown-item py-2">
                    <!-- <a href="<?php echo BASE_URL; ?>logout.php" class="text-body ms-0"> -->
