...
class Pagination{ 
    ...
    var $prevLink       = '⇠'; 
    var $lastLink       = '⇥'; 
    var $fullTagOpen    = '<ul class="pagination-flat justify-content-center twbs-prev-next pagination mt-2">'; 
    var $fullTagClose   = '</ul>'; 
    var $firstTagOpen   = '<li class="page-item first">'; 
    var $firstTagClose  = '</li>'; 
    var $lastTagOpen    = '<li class="page-item last">'; 
    var $lastTagClose   = '</li>'; 
    var $curTagOpen     = '<li class="page-item active">'; 
    var $curTagClose    = '</li>'; 
    var $nextTagOpen    = '<li class="page-item next">'; 
    var $nextTagClose   = '</li>'; 
    var $prevTagOpen    = '<li class="page-item prev">'; 
    var $prevTagClose   = '</li>'; 
        ...
        for ($loop = $start -1; $loop <= $end; $loop++){ 
            ...
            if ($i >= 0){ 
                if ($this->currentPage == $loop){ 
                    //
                    $activeHtml="<a href=\"javascript:void(0);\" " . $this->anchorClass . " 
                    >". $loop .'</a>';
                    $output .= $this->curTagOpen.$activeHtml.$this->curTagClose; 
                }else{ 
                    $n = ($i == 0) ? '' : $i; 
