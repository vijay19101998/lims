$(function() {
  ...
  //
    $('#addtestGroup').click(function(){
      ...
      $('#testGroupForm')[0].reset();
      $('.modal-title').html("<i class='fa fa-plus'></i> Add Test Group");
      $('#action').val('Add');
    ...
    //
    var demoDatatable = $('#testGroupList').DataTable({
      'processing': true,
      'serverSide': true,
      'serverMethod': 'post',
      'ajax':{
      ...
      submitHandler: function(form) {
        ...
        var formData = new FormData(form);
          ...
          $.ajax({
            ...
            $('#testGroupList').DataTable().ajax.reload();
            }
    ...
    $(document).on('click', '.update', function(){
      ...
      $.ajax({
        ...
        success:function(data){
          ...
          $('#testGroupModal').modal('show');
          $('#name').val(data.name);
          $('#test_category_id').val(data.test_category_id);
