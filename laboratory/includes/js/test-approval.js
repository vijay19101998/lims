        ...
        $.ajax({
          ...
          success:function(odata) {
            if(odata.status=="success"){
              ...
              // window.location.href = "test-lib.php";
              history.go(-1);
              // $('#userForm')[0].reset();
...
$(document).ready(function(){
 ...
 // multi add
  ...
  $("body").on('click', '.addMoreData', function(e) {
      ...
      x++;
      $("#snoid").val(x);
    $('#additionalContiner').append('<tr id="additionalContinerId'+x+'"><input class="col form-control" type="hidden" name="id[]" value=""><td><input class="col form-control" type="text" name="parameters[]"></td> <td><input class="col form-control" type="text" name="protocols[]"></td><td><select class="col-12 form-control" name="specification[]"><option value="">--Select--</option><option value="1">Select1</option></select></td>  <td><input class="col form-control" type="text" name="text[]"></td>  <td><input class="col form-control" type="text" name="unit[]"></td>  <td><input class="col-12 form-control" type="text" id="" name="value[]" ></td> <td><button type="button" class="btn btn-danger btn-xs additionalContinerRemove" value="' + x + '">Remove</button></td></tr>');
  });
