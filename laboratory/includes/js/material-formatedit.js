        ...
        success: function (odata) {
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              $(".js-example-tags,.js-example-tags1").select2({
                tags: true
            });
...
//
    ...
    //   x++;
    //   $("#snoid").val(x);
    //   $('#additionalContiner').append('<tr id="additionalContinerId' + x + '"><td hidden><input class="col form-control form-control-xs" type="" name="mid[]" value=""></td><td style="width:5em;"><input class="col form-control form-control-xs"  style="width:5em;" type="text"></td><td><input class="col form-control form-control-xs" type="text" name="parameters[]"></td> <td><input class="col form-control form-control-xs" type="text" name="protocols[]"></td><td><select class="col-12 form-control form-control-xs" name="specification[]"><option value="text">Text</option><option value="min">Min</option><option value="max">Max</option></select></td>  <td><input class="col form-control form-control-xs" type="text" name="text[]"></td>  <td><input class="col form-control" type="text" name="unit[]"></td> <td><button type="button" class="btn btn-danger btn-xs additionalContinerRemove" value="' + x + '" style="padding: 0.213rem 0.6rem;"><i class="mdi mdi-close-circle m-0"></i></button></td></tr>');
    // });
//
 // multi add
 var x = $("#snoid").val();
