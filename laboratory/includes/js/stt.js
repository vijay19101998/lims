$(function() {
  ...
  //
    $('#addtestGroup').click(function(){
      ...
      $('#testtypeform')[0].reset();
      $('.modal-title').html("<i class='fa fa-plus'></i> Add Standard Test Type");
      $('#action').val('Add');
    ...
    //
    var demoDatatable = $('#testtypelist').DataTable({
      'processing': true,
      'serverSide': true,
      'serverMethod': 'post',
      'ajax':{
      ...
      submitHandler: function(form) {
        ...
        var formData = new FormData(form);
          ...
          $.ajax({
            ...
            $('#testtypelist').DataTable().ajax.reload();
            }
    ...
    const swalWithBootstrapButtons = Swal.mixin({
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.value) {
          ...
          //
          var id = $(this).attr("id");
          var form_action = 'tbl_standard_test_type';
