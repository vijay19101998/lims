...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Re-test Approval</li>
    </ol>
</nav>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive-md">
                    <table id="testRetest" class="table table-bordered table-striped table-hover mt-3">
                        <thead>
                            <tr>
                                <th class="col-2">Date</th>
                                <th class="col-2">test Code</th>
                                <th class="col-3">Name of the test</th>
                                <th class="col-3">Standard Test Type</th>
                                <th class="col-3">Prepared By</th> 
                            </tr>
                        </thead>
...
<script src="<?php echo BASE_URL; ?>includes/js/test-retest_app.js"></script>
<script>
