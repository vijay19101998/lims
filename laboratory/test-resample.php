...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Re-sample Approval</li>
    </ol>
</nav>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive-md">
                    <table id="testResample" class="table table-bordered table-striped table-hover mt-3">
                        <thead>
                            <tr>
...
<script src="<?php echo BASE_URL; ?>includes/js/test-resample_app.js"></script>
<script>
